...
implements Reducer<Text, IntWritable, Text, IntWritable>{
	...
	private String getWeek(int idx) {
		String week = "";
		if(idx==1)	week = "월 요 일";
		else if(idx==2)	week = "화 요 일";
		else if(idx==3)	week = "수 요 일";
		else if(idx==4)	week = "목 요 일";
		else if(idx==5)	week = "금 요 일";
		else if(idx==6)	week = "토 요 일";
		else if(idx==7)	week = "일 요 일";
	...
	public void reduce(Text key, Iterator<IntWritable> values,
		...
		output.collect(new Text(getWeek(Integer.parseInt(key.toString()) )), getTotalCnt(values));
