			...
			<div class="container" id="wrap">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<form name="insert.jsp" method="POST">
							<center>
								<legend>
									<h2>회원가입</h2>
								</legend>
							...
							<br>
							<input type="password" id="pw1" name="pw1" class="form-control input-lg"
								placeholder="패스워드 (6자 이상)" />
							<br>
							<input type="password" id="pw2" class="form-control input-lg" placeholder="패스워드 재입력"
								onblur="" />
							<br>
							<div class="alert alert-warning" id="alert-check">비밀번호를 6자 이상 써주세요.</div>
							...
							<div class="row">
								<div class="col-xs-6 col-md-6">
									<input type="text" name="eId" class="form-control input-lg" placeholder="Email">
								</div>
								<div class="col-xs-6 col-md-6"> 
									<select name="eAdd" class="form-control input-lg">
